			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="intitule" title="${message(code: 'type.intitule.label', default: 'Intitule')}" />
				...
				<g:each in="${typeInstanceList}" status="i" var="typeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${typeInstance.id}">${fieldValue(bean: typeInstance, field: "intitule")}</g:link></td>
